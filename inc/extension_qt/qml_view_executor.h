...
public:
    ...
    virtual void TouchPinchZoom(const ElementId &element, const double &scale) NOT_SUPPORTED_IMPL;
    virtual void TouchPinchRotate(const ElementId &element, const int &angle) NOT_SUPPORTED_IMPL;
