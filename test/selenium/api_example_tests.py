...
class ApiExampleTest (unittest.TestCase):
    ...
    def testGetCurrentUrl(self):
        ...
        self.assertEquals("http://localhost:%d/simpleTest.html" % 9517, url)
    ...
    def testGetAttribute(self):
        ...
        self.assertEquals("http://localhost:%d/xhtmlTest.html#" % 9517, attr)
    ...
    def _pageURL(self, name):
        return "http://localhost:%d/%s.html" % (9517, name)
